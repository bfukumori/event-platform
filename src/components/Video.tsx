  ...
  if (loading) {
    return (
      <div className="flex-1 flex items-center justify-center ">
        <CircleNotch
          weight="bold"
          className="w-96 h-96 animate-spin text-green-500"
        />
      </div>
    );
  }
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex flex-col md:flex-row items-start gap-16">
          ...
          <div className="flex flex-col gap-4 w-full md:w-fit">
            ...
            <a
              href="#"
              className="p-4 text-sm border border-blue-500 hover:bg-blue-500 hover:text-gray-900 transition-colors text-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center"
            >
              <Lightning size={24} />
              Acesse o desafio
            </a>
